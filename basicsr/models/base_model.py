...
class BaseModel():
    ...
    def data_ensemble_validation(self, dataloader, current_iter, tb_logger, save_img=False):
        """Validation function.
        ...
        """
        if self.opt['dist']:
            self.data_ensemble_dist_validation(dataloader, current_iter, tb_logger, save_img)
        else:
